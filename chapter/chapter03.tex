...
INDI理论的一个核心假设是时间尺度分离法则\cite{doi:10.2514/6.2021-1457}，该法则基于系统动力学的时间尺度特性，指出系统内部状态变量的动态响应速率要明显慢于外部输入信号的时变特性。基于这一动力学特性差异，相比于外部输入信号的导数项，系统状态变量的导数项可以视为高阶小量并忽略不计，从而有效地简化系统的动态方程。
