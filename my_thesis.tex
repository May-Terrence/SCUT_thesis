...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%——by MCH
%编译范围
% \includeonly{chapter/symbols}
% \includeonly{chapter/chapter02}
%参考文献设置
% \usepackage[backend=biber,style=gb7714-1987,gbalign=gb7714-2015,gbpub=false,gbtype =true,gbmedium =true,gbnamefmt = lowercase]{biblatex}% 可试着设style=gb7714-1987
\usepackage[backend=biber,style=gb7714-2015,gbalign=gb7714-2015,gbpub=false,gbnamefmt = lowercase,eprint=false,gbpunctin=false]{biblatex}
...
\addbibresource[location=local]{biblibrary/my_thesis.bib}
\addbibresource[location=local]{biblibrary/not_in_zotero.bib}
%页眉页脚设置
\usepackage{fancyhdr}
\usepackage{listings}
\usepackage{xunicode}
