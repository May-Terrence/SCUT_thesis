...
\addbibresource[location=local]{biblibrary/my_thesis.bib} % 如果在其他盘，改为相对路径。比如F盘，改为：F/MyLibrary.bib
\addbibresource[location=local]{biblibrary/not_in_zotero.bib} % 无论什么来源的bib文件，只要由参考文献的BibTeX组成，都可以使用此模板。参考文献的BibTeX获取方法可百度
...
\begin{document}
    ...
    \let\cleardoublepage\clearpage %新增此行，取消偶数页空白
